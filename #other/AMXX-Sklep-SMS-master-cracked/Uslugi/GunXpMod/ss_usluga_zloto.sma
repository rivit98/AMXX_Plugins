...
#define NAZWA_DL "Zloto" 				//Nazwa uslugi wyswietlana w menu
#define NAZWA_KR "zloto" 				//nazwa uslugi uzywana w logach, jako okienko MOTD itd.
...
public ss_buy_service_post(id, iUsluga, iJednostkaIlosci)
{
	...
	set_user_zloto(id, get_user_zloto(id) + str_to_num(g_szJednostkaIlosci[iJednostkaIlosci][0]));
