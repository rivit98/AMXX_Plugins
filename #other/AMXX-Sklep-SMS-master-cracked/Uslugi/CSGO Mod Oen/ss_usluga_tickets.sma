...
native csgo_add_ticket(id, ile); 

new g_iUsluga;

#define NAZWA_DL "Bony na jackpot" 			//Nazwa uslugi wyswietlana w menu
#define NAZWA_KR "tickets" 				//nazwa uslugi uzywana w logach, jako okienko MOTD itd.
...
public ss_buy_service_post(id, iUsluga, iJednostkaIlosci)
{
	...
	csgo_add_ticket(id, str_to_num(g_szJednostkaIlosci[iJednostkaIlosci][0]));
