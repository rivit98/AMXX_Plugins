...
#define NAZWA_DL "Fragi" 				//Nazwa uslugi wyswietlana w menu
#define NAZWA_KR "fragi" 				//nazwa uslugi uzywana w logach, jako okienko MOTD itd.
...
public ss_buy_service_post(id, iUsluga, iJednostkaIlosci)
{
	...
	csgo_set_user_frags(id, csgo_get_user_frags(id) + str_to_num(g_szJednostkaIlosci[iJednostkaIlosci][0]));
