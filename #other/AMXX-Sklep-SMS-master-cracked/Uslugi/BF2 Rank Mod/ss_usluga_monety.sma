...
native bf_get_user_coins(id);
native bf_set_user_coins(id, wartosc);

new g_iUsluga;

#define NAZWA_DL "Monety" 				//Nazwa uslugi wyswietlana w menu
...
public ss_buy_service_post(id, iUsluga, iJednostkaIlosci)
{
	...
	bf_set_user_coins(id, bf_get_user_coins(id) + str_to_num(g_szJednostkaIlosci[iJednostkaIlosci][0]));
