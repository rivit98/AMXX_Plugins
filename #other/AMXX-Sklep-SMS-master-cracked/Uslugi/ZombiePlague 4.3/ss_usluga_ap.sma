...
#define NAZWA_DL "Ammp Packi" 				//Nazwa uslugi wyswietlana w menu
#define NAZWA_KR "ap" 				//nazwa uslugi uzywana w logach, jako okienko MOTD itd.
...
public ss_buy_service_post(id, iUsluga, iJednostkaIlosci)
{
	...
	zp_set_user_ammo_packs(id, zp_get_user_ammo_packs(id) + str_to_num(g_szJednostkaIlosci[iJednostkaIlosci][0]));
