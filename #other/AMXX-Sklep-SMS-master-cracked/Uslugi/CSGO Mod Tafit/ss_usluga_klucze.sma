...
native ustaw_klucze(id, amount);
native pobierz_klucze(id);

new g_iUsluga;

#define NAZWA_DL "Klucze do skrzynek" 				//Nazwa uslugi wyswietlana w menu
...
public ss_buy_service_post(id, iUsluga, iJednostkaIlosci)
{
	...
	ustaw_klucze(id, pobierz_klucze(id) + str_to_num(g_szJednostkaIlosci[iJednostkaIlosci][0]));
