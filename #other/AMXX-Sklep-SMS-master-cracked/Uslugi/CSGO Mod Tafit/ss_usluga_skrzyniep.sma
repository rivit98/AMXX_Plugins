...
native ustaw_skrzyniep(id, amount);
native pobierz_skrzyniep(id);

new g_iUsluga;

#define NAZWA_DL "Skrzynie Premium" 				//Nazwa uslugi wyswietlana w menu
#define NAZWA_KR "skrzyniep" 				//nazwa uslugi uzywana w logach, jako okienko MOTD itd.
...
public ss_buy_service_post(id, iUsluga, iJednostkaIlosci)
{
	...
	ustaw_skrzyniep(id, pobierz_skrzyniep(id) + str_to_num(g_szJednostkaIlosci[iJednostkaIlosci][0]));
