...
native ustaw_walute(id, amount);
native pobierz_walute(id);

new g_iUsluga;

#define NAZWA_DL "Punkty" 				//Nazwa uslugi wyswietlana w menu
#define NAZWA_KR "punkty" 				//nazwa uslugi uzywana w logach, jako okienko MOTD itd.
...
public ss_buy_service_post(id, iUsluga, iJednostkaIlosci)
{
	...
	ustaw_walute(id, pobierz_walute(id) + str_to_num(g_szJednostkaIlosci[iJednostkaIlosci][0]));
