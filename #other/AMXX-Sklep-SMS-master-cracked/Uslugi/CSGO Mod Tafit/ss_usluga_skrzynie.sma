...
native ustaw_skrzynie(id, amount);
native pobierz_skrzynie(id);

new g_iUsluga;

#define NAZWA_DL "Skrzynie" 				//Nazwa uslugi wyswietlana w menu
#define NAZWA_KR "skrzynie" 				//nazwa uslugi uzywana w logach, jako okienko MOTD itd.
...
public ss_buy_service_post(id, iUsluga, iJednostkaIlosci)
{
	...
	ustaw_skrzynie(id, pobierz_skrzynie(id) + str_to_num(g_szJednostkaIlosci[iJednostkaIlosci][0]));
