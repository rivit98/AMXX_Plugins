...
#define NAZWA_DL "Doswiadczenie" 				//Nazwa uslugi wyswietlana w menu
#define NAZWA_KR "doswiadczenie" 				//nazwa uslugi uzywana w logach, jako okienko MOTD itd.
...
public ss_buy_service_post(id, iUsluga, iJednostkaIlosci)
{
	...
	cod_set_user_xp(id, cod_get_user_xp(id) + str_to_num(g_szJednostkaIlosci[iJednostkaIlosci][0]));
