...
#define NAZWA_DL "Dolary na jackpot" 			//Nazwa uslugi wyswietlana w menu
#define NAZWA_KR "dolary" 				//nazwa uslugi uzywana w logach, jako okienko MOTD itd.
...
public ss_buy_service_post(id, iUsluga, iJednostkaIlosci)
{
	...
	csgo_add_money(id, str_to_float(g_szJednostkaIlosci[iJednostkaIlosci][0]));
